          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-kas-slate font-light leading-relaxed">
                <p>
                  My journey into fragrance began not in a laboratory, but in my grandmother's
                  garden in Portugal. The scent of orange blossoms on warm summer evenings,
                  the earthy petrichor after rain, the comforting embrace of her rose water
                  — these memories shaped my understanding of how powerful scent can be.
                </p>
                <p>
                  After years of working in the beauty industry, I realized that most
                  commercial fragrances had lost their soul. Mass production had replaced
                  artistry. Synthetic shortcuts had replaced quality ingredients.
                  I knew there had to be another way.
                </p>
                <p>
                  In 2020, I opened my small studio in Portugal and began creating
                  fragrances the way I believed they should be made: by hand, in small
                  batches, using only the finest European ingredients. No shortcuts.
                  No compromises.
                </p>
                <p>
                  Every bottle of KAS is a piece of my heart. I personally blend each
                  fragrance, testing and refining until it's perfect. When you wear KAS,
                  you're not just wearing a perfume — you're wearing a story, crafted
                  with love and intention.
                </p>
              </div>

              <div className="mt-8 p-6 bg-kas-sand/50 rounded-xl">
                <blockquote className="font-serif text-lg text-kas-charcoal italic">
                  "I believe fragrance is deeply personal. Each bottle I create carries
                  a piece of my heart — I want you to feel that when you wear it."
                </blockquote>
                <p className="mt-4 text-kas-gold font-medium">— Kim, Founder</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div className="text-center">
              <span className="font-serif text-5xl md:text-6xl text-kas-gold">01</span>
              <div className="w-16 h-16 mx-auto mt-6 mb-4 flex items-center justify-center rounded-full bg-kas-sand/50">
            ...
            {/* Step 02 - Sourcing */}
            <div className="text-center">
              <span className="font-serif text-5xl md:text-6xl text-kas-gold">02</span>
              <div className="w-16 h-16 mx-auto mt-6 mb-4 flex items-center justify-center rounded-full bg-kas-sand/50">
                <svg className="w-8 h-8 text-kas-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Step 03 - Blending */}
            <div className="text-center">
              <span className="font-serif text-5xl md:text-6xl text-kas-gold">03</span>
              <div className="w-16 h-16 mx-auto mt-6 mb-4 flex items-center justify-center rounded-full bg-kas-sand/50">
                <svg className="w-8 h-8 text-kas-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Step 04 - Crafting */}
            <div className="text-center">
              <span className="font-serif text-5xl md:text-6xl text-kas-gold">04</span>
              <div className="w-16 h-16 mx-auto mt-6 mb-4 flex items-center justify-center rounded-full bg-kas-sand/50">
                <svg className="w-8 h-8 text-kas-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
